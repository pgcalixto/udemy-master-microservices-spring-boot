package com.pgcalixto.calixtobank.cards.controller;
...
import com.pgcalixto.calixtobank.cards.dto.ErrorResponseDto;
import com.pgcalixto.calixtobank.cards.dto.ResponseDto;
import com.pgcalixto.calixtobank.cards.service.CardService;

@Tag(
        name = "CRUD REST APIs for Cards in CalixtoBank",
        description = "CRUD REST APIs in CalixtoBank to CREATE, UPDATE, FETCH AND DELETE card details"
)
@RestController
...
public class CardController {
    ...
    @Operation(
            ...
            description = "REST API to create new Card inside CalixtoBank"
    )
    @ApiResponse(
            responseCode = "201",
    ...
    public ResponseEntity<CardDto> fetchCardDetails(
        ...
        final CardDto cardDto = cardService.fetchCard(mobileNumber);
